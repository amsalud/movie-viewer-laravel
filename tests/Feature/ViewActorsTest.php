...
class ViewActorsTest extends TestCase
{
    ...
    {
        Http::fake([
            'https://api.themoviedb.org/3/person/2888?append_to_response=external_ids,combined_credits' => $this->fakeActor(),
        ]);
    ...
    private function fakeActor()
    {
        return Http::response([
                ...
                "external_ids" => $this->fakeSocial(),
                "combined_credits" => $this->fakeCredits()
            ], 200);
    }

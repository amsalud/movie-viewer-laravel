...
<div class="actor-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="{{$actor['profile_path']}}" alt="profile image" class="w-76 md:w-96">
            <ul class="flex items-center mt-4">
                @if($actor['social_media_links']['facebook'])
                <li>
                    <a href="{{$actor['social_media_links']['facebook']}}" target="_blank" title="Facebook">
                ...
                @endif
                @if($actor['social_media_links']['instagram'])
                <li class="ml-6">
                    <a href="{{$actor['social_media_links']['instagram']}}" target="_blank" title="Instagram">
                        <svg class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 448 512">
                ...
                @endif
                @if($actor['social_media_links']['twitter'])
                <li class="ml-6">
                    <a href="{{$actor['social_media_links']['twitter']}}" target="_blank" title="Twitter">
        ...
        <div class="md:ml-24">
            ...
            <div class="flex flex-wrap items-center text-gray-400 text-sm">
                ...
                <span class="ml-2">{{$actor['birthday']}} ({{ $actor['age'] }} years old) {{ $actor['place_of_birth'] ? ' in ' . $actor['place_of_birth'] : ''}}</span>
            </div>
